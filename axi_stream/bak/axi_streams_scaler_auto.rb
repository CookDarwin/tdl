...
class AxiStream
    ...
    def axi_streams_scaler(mode:"BOTH",cut_or_combin_body:"ON",dsize:8,new_body_len:"new_body_len",head_inf:"head_inf",body_inf:"body_inf",end_inf:"end_inf",m00:"m00",up_stream:nil,down_stream:nil)
        ...
        m00 = self unless self==AxiStream.NC
         ...
         @instance_draw_stack << lambda { axi_streams_scaler_draw(mode:mode,cut_or_combin_body:cut_or_combin_body,dsize:dsize,new_body_len:new_body_len,head_inf:head_inf,body_inf:body_inf,end_inf:end_inf,m00:m00,up_stream:up_stream,down_stream:down_stream) }
...
"
    ...
    def self.axi_streams_scaler(mode:"BOTH",cut_or_combin_body:"ON",dsize:8,new_body_len:"new_body_len",head_inf:"head_inf",body_inf:"body_inf",end_inf:"end_inf",m00:"m00",up_stream:nil,down_stream:nil)
        ...
        if down_stream.is_a? AxiStream
            ...
            AxiStream.NC.axi_streams_scaler(mode:mode,cut_or_combin_body:cut_or_combin_body,dsize:dsize,new_body_len:new_body_len,head_inf:head_inf,body_inf:body_inf,end_inf:end_inf,m00:m00,up_stream:up_stream,down_stream:down_stream)
        end
        return return_stream
    end
...
class Tdl
    ...
    def Tdl.inst_axi_streams_scaler(
        mode:"BOTH",
        ...
        unless mode.is_a? Hash
            ...
            raise TdlError.new('axi_streams_scaler Parameter mode TdlHash cant include Proc') if mode.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless cut_or_combin_body.is_a? Hash
            ...
            raise TdlError.new('axi_streams_scaler Parameter cut_or_combin_body TdlHash cant include Proc') if cut_or_combin_body.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless dsize.is_a? Hash
            ...
            raise TdlError.new('axi_streams_scaler Parameter dsize TdlHash cant include Proc') if dsize.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless new_body_len.is_a? Hash
            ...
            raise TdlError.new('axi_streams_scaler Logic new_body_len TdlHash cant include Proc') if new_body_len.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless head_inf.is_a? Hash
            ...
            raise TdlError.new('axi_streams_scaler AxiStream head_inf TdlHash cant include Proc') if head_inf.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless body_inf.is_a? Hash
            ...
            raise TdlError.new('axi_streams_scaler AxiStream body_inf TdlHash cant include Proc') if body_inf.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless end_inf.is_a? Hash
            ...
            raise TdlError.new('axi_streams_scaler AxiStream end_inf TdlHash cant include Proc') if end_inf.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless m00.is_a? Hash
            ...
            raise TdlError.new('axi_streams_scaler AxiStream m00 TdlHash cant include Proc') if m00.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
                a = AxiStream.new(m00)
                unless m00[:name]
                    a.name = "m00"
        ...
        hash.push_to_module_stack(AxiStream,:axi_streams_scaler)
