...
class AxiStream
    ...
    def axis_connect_pipe(axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)
        ...
        axis_out = self unless self==AxiStream.NC
         ...
         @instance_draw_stack << lambda { axis_connect_pipe_draw(axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream) }
        return return_stream
    end

    def axis_connect_pipe_draw(axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)

        large_name_len(axis_in,axis_out)
"
// FilePath:::../../axi/AXI_stream/axis_connect_pipe.sv
axis_connect_pipe axis_connect_pipe_#{signal}_inst(
...
"
    ...
    def self.axis_connect_pipe(axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)
        return_stream = nil
        ...
        if down_stream.is_a? AxiStream
            down_stream.axis_connect_pipe(axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        elsif axis_out.is_a? AxiStream
            axis_out.axis_connect_pipe(axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        else
            AxiStream.NC.axis_connect_pipe(axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        end
        return return_stream
    end
...
class TdlTest
    ...
    def self.test_axis_connect_pipe
        ...
        AxiStream.axis_connect_pipe(axis_in:axis_in,axis_out:axis_out)
