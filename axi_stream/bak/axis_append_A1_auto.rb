...
class AxiStream
    ...
    def axis_append_a1(mode:"BOTH",dsize:8,head_field_len:16*8,head_field_name:"HEAD Filed",end_field_len:16*8,end_field_name:"END Filed",enable:"enable",head_value:"head_value",end_value:"end_value",origin_in:"origin_in",append_out:"append_out",up_stream:nil,down_stream:nil)
        ...
        Tdl.add_to_all_file_paths(['axis_append_a1','../../axi/AXI_stream/axis_append_A1.sv'])
        return_stream = self
...
"
// FilePath:::../../axi/AXI_stream/axis_append_A1.sv
axis_append_A1#(
...
class Tdl
    ...
    def Tdl.inst_axis_append_a1(
        ...
        unless mode.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Parameter mode TdlHash cant include Proc') if mode.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless dsize.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Parameter dsize TdlHash cant include Proc') if dsize.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless head_field_len.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Parameter head_field_len TdlHash cant include Proc') if head_field_len.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless head_field_name.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Parameter head_field_name TdlHash cant include Proc') if head_field_name.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless end_field_len.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Parameter end_field_len TdlHash cant include Proc') if end_field_len.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless end_field_name.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Parameter end_field_name TdlHash cant include Proc') if end_field_name.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless enable.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Logic enable TdlHash cant include Proc') if enable.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
                a = Logic.new(enable)
                unless enable[:name]
                    a.name = "enable"
        ...
        unless head_value.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Logic head_value TdlHash cant include Proc') if head_value.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless end_value.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 Logic end_value TdlHash cant include Proc') if end_value.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless origin_in.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 AxiStream origin_in TdlHash cant include Proc') if origin_in.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        unless append_out.is_a? Hash
            ...
            raise TdlError.new('axis_append_a1 AxiStream append_out TdlHash cant include Proc') if append_out.select{ |k,v| v.is_a? Proc }.any?
            lam = lambda {
        ...
        hash.push_to_module_stack(AxiStream,:axis_append_a1)
