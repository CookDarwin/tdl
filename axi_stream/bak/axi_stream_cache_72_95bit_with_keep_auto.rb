...
class AxiStream
    ...
    def axi_stream_cache_72_95bit_with_keep(axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)
        ...
        axis_out = self unless self==AxiStream.NC
         ...
         @instance_draw_stack << lambda { axi_stream_cache_72_95bit_with_keep_draw(axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream) }
        return return_stream
    end

    def axi_stream_cache_72_95bit_with_keep_draw(axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)

        large_name_len(axis_in,axis_out)
"
// FilePath:::../../axi/AXI_stream/stream_cache/axi_stream_cache_72_95bit_with_keep.sv
axi_stream_cache_72_95bit_with_keep axi_stream_cache_72_95bit_with_keep_#{signal}_inst(
...
"
    ...
    def self.axi_stream_cache_72_95bit_with_keep(axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)
        return_stream = nil
        ...
        if down_stream.is_a? AxiStream
            down_stream.axi_stream_cache_72_95bit_with_keep(axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        elsif axis_out.is_a? AxiStream
            axis_out.axi_stream_cache_72_95bit_with_keep(axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        else
            AxiStream.NC.axi_stream_cache_72_95bit_with_keep(axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        end
        return return_stream
    end
...
class TdlTest
    ...
    def self.test_axi_stream_cache_72_95bit_with_keep
        c0 = Clock.new(name:"axi_stream_cache_72_95bit_with_keep_clk",freqM:148.5)
        r0 = Reset.new(name:"axi_stream_cache_72_95bit_with_keep_rst_n",active:"low")
        ...
        AxiStream.axi_stream_cache_72_95bit_with_keep(axis_in:axis_in,axis_out:axis_out)
