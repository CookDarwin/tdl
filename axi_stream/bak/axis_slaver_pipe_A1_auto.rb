...
class AxiStream
    ...
    def axis_slaver_pipe_a1(depth:1,axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)
        ...
        axis_out = self unless self==AxiStream.NC
         ...
         @instance_draw_stack << lambda { axis_slaver_pipe_a1_draw(depth:depth,axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream) }
        return return_stream
    end

    def axis_slaver_pipe_a1_draw(depth:1,axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)
...
) axis_slaver_pipe_A1_#{signal}_inst(
...
"
    ...
    def self.axis_slaver_pipe_a1(depth:1,axis_in:"axis_in",axis_out:"axis_out",up_stream:nil,down_stream:nil)
        return_stream = nil
        ...
        if down_stream.is_a? AxiStream
            down_stream.axis_slaver_pipe_a1(depth:depth,axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        elsif axis_out.is_a? AxiStream
            axis_out.axis_slaver_pipe_a1(depth:depth,axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        else
            AxiStream.NC.axis_slaver_pipe_a1(depth:depth,axis_in:axis_in,axis_out:axis_out,up_stream:up_stream,down_stream:down_stream)
        end
        return return_stream
    end
...
class TdlTest
    ...
    def self.test_axis_slaver_pipe_a1
        c0 = Clock.new(name:"axis_slaver_pipe_a1_clk",freqM:148.5)
        r0 = Reset.new(name:"axis_slaver_pipe_a1_rst_n",active:"low")

        depth = Parameter.new(name:"depth",value:1)
        ...
        AxiStream.axis_slaver_pipe_a1(depth:depth,axis_in:axis_in,axis_out:axis_out)
