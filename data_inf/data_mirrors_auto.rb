...
class DataInf_C
    ...
    def data_mirrors(
        ...
        # GlobalParam.CurrTdlModule.add_to_all_file_paths(['data_mirrors','../../axi/data_interface/data_inf_c/data_mirrors.sv'])
        return_stream = self
        ...
        if up_stream.nil? && data_in.eql?("data_in") && (!(data_mirror.eql?("data_mirror")) || !down_stream.nil?)
            ...
            return down_stream.data_mirrors(data_in:self)
        end
        ...
        belong_to_module.DataInf_C_draw << data_mirrors_draw(
            h:h,
            l:l,
            num:num,
            mode:mode,
    ...
    def data_mirrors_draw(
        ...
        instance_name = "data_mirrors_#{signal}_inst"
"
...
"
    ...
    def self.data_mirrors(
        ...
        if down_stream.is_a? DataInf_C
            ...
            belong_to_module.DataInf_C_NC.data_mirrors(
                h:h,
                l:l,
                num:num,
                mode:mode,
