...
class DataInf_C
    ...
    def _datainf_c_slaver_empty(slaver:"slaver",up_stream:nil)
        ...
        slaver = up_stream if up_stream
         ...
         @instance_draw_stack << lambda { _datainf_c_slaver_empty_draw(slaver:slaver,up_stream:up_stream) }
...
"
    ...
    def self.datainf_c_slaver_empty(slaver:"slaver",up_stream:nil)
        ...
        DataInf_C.NC._datainf_c_slaver_empty(slaver:slaver,up_stream:up_stream)
        return return_stream
    end
...
class TdlTest
    ...
    def self.test_datainf_c_slaver_empty
        c0 = Clock.new(name:"datainf_c_slaver_empty_clk",freqM:148.5)
        r0 = Reset.new(name:"datainf_c_slaver_empty_rst_n",active:"low")

        slaver = DataInf_C.new(name:"slaver",clock:c0,reset:r0)
        up_stream = slaver
        
        DataInf_C.datainf_c_slaver_empty(slaver:slaver)
