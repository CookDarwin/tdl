...
class Axi4
    ...
    def _axi4_direct_verb(
        ...
        master = Axi4.same_name_socket(:to_down,mix=true,master) unless master.is_a? String
         ...
         @instance_draw_stack << lambda { _axi4_direct_verb_draw(
            slaver:slaver,
            master:master) }
...
axi4_direct_verb axi4_direct_verb_#{signal}_inst(
...
class TdlTest
    ...
    def self.test_axi4_direct_verb
        c0 = Clock.new(name:"axi4_direct_verb_clk",freqM:148.5)
        r0 = Reset.new(name:"axi4_direct_verb_rst_n",active:"low")

        slaver = Axi4.new(name:"slaver",clock:c0,reset:r0)
        master = Axi4.new(name:"master",clock:c0,reset:r0)
        
        
        Axi4.axi4_direct_verb(
            slaver:slaver,
            master:master)
