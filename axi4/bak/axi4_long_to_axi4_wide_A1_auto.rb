...
class Axi4
    ...
    def _axi4_long_to_axi4_wide_a1(
        ...
        master = Axi4.same_name_socket(:to_down,mix=true,master) unless master.is_a? String
         ...
         @instance_draw_stack << lambda { _axi4_long_to_axi4_wide_a1_draw(
            partition:partition,
            slaver:slaver,
            master:master) }
...
) axi4_long_to_axi4_wide_A1_#{signal}_inst(
...
"
    ...
    def self.axi4_long_to_axi4_wide_a1(
        ...
        Axi4.NC._axi4_long_to_axi4_wide_a1(
            partition:partition,
                slaver:slaver,
                master:master)
        return return_stream
...
class TdlTest
    ...
    def self.test_axi4_long_to_axi4_wide_a1
        c0 = Clock.new(name:"axi4_long_to_axi4_wide_a1_clk",freqM:148.5)
        r0 = Reset.new(name:"axi4_long_to_axi4_wide_a1_rst_n",active:"low")
        ...
        Axi4.axi4_long_to_axi4_wide_a1(
            partition:partition,
            slaver:slaver,
            master:master)
